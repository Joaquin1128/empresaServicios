...
public class EmpresaDeServiciosTest {
	...
	public void setUp() throws Exception {
		...
		codServicio_cli1_pintor1 = empresa.solicitarServicioPintura(30449448, nroEspecialistaPintorAltura1,
				"calle falsa 123", 24, 4500, 2, 18000, 5000);
		int cli2_elec2 = empresa.solicitarServicioElectricidad(37223451, nroEspecialistaElectrisista, "otra Calle 321",
				650, 2);
		codServicio_cli2_gasista = empresa.solicitarServicioGasistaInstalacion(37223451,
				nroEspecialistaGasistaInstalacion, "bulevar 333", 3, 3200);
		int cli1_elec2 = empresa.solicitarServicioElectricidad(30449448, nroEspecialistaElectrisista, "calle falsa 139",
				650, 10);
